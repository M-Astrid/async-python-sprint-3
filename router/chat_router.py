...
from model.custom_http import Response, Request
...
class ChatRouter:
    ...
    async def send_private(self, request):
        ...
        if not msg.to_username or not msg.from_username:
            return Response(
                ...
                body="to_username and from_username are required",
            )
    ...
    async def send_all(self, request: Request):
        ...
        if not msg.from_username:
            return Response(
                HTTPStatus.BAD_REQUEST,
                HTTPStatus.BAD_REQUEST.phrase,
                body="from_username is required",
            )
    ...
    async def get_status(self):
        return Response(
            ...
            headers=None,
            body=await self.chat.get_status(),
        )
